...
urlpatterns = [
    ...
    path('food-in-an-event/<int:pk>/', views.FoodInAnEventDetail.as_view(), name='foodinanevent-detail'),
    path('food-in-an-event/<int:pk>/content', views.FoodInAnEventHtml.as_view(), name='food-in-an-event-html'),
    path('animal-in-an-event/', views.AnimalInAnEventList.as_view(), name='animal-in-an-event-list'),
    path('animal-in-an-event/<int:pk>/', views.AnimalInAnEventDetail.as_view(), name='animalinanevent-detail'),
